		...
		<>
			...
			<div className="p-5 mt-10 mx-auto sm:p-10 md:p-16 dark:text-gray-800 container">
				<div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
					<div alt="" className="w-full h-60 sm:h-96 bg-gray-500" style={{ backgroundImage: `url(${target.imgsLink.type})`, backgroundPosition: "center center", backgroundSize: "cover" }}></div>
			...
			<div className="container text-center text-white mx-auto my-10">
				<NavLink className={"Container"} to={"/poems"}>
