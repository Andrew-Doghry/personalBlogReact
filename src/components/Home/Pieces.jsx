    ...
    <section id="more" className={`object-cover container flex items-center justify-center mt-10  flex-col   ${isRight ? "lg:flex-row" : "lg:flex-row-reverse"} my-4`}>
      <div className=" py-8  text-center lg:py-16 lg:px-6">
        <figure className="max-w-screen-md mx-auto relative">
          <blockquote>
            <svg className="inline-block mr-2 h-12    text-flareOrange/70" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M14.017 18L14.017 10.609C14.017 4.905 17.748 1.039 23 0L23.995 2.151C21.563 3.068 20 5.789 20 8H24V18H14.017ZM0 18V10.609C0 4.905 3.748 1.038 9 0L9.996 2.151C7.563 3.068 6 5.789 6 8H9.983L9.983 18L0 18Z" fill="currentColor" />
            </svg>
            <p className="inline text-2xl font-medium  text-white">{sample}</p>
            <svg className="absolute right-0 h-12 mx-auto mb-3   text-flareOrange/70 rotate-180 " viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M14.017 18L14.017 10.609C14.017 4.905 17.748 1.039 23 0L23.995 2.151C21.563 3.068 20 5.789 20 8H24V18H14.017ZM0 18V10.609C0 4.905 3.748 1.038 9 0L9.996 2.151C7.563 3.068 6 5.789 6 8H9.983L9.983 18L0 18Z" fill="currentColor" />
            </svg>
          </blockquote>
          <figcaption className="flex items-center justify-center mt-6 space-x-3">
            {/* <img className="w-6 h-6 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gouch.png" alt="profile picture"> */}
            <div className="flex items-center divide-x-2  hover:underline transition divide-gray-700">
              <NavLink to={`/${(name == 'Collections') ? 'coll' : name}`} className="pr-3 font-medium text-oragne-600  text-orange-600">{name}</NavLink>
            </div>
          </figcaption>
        </figure>
      </div>
