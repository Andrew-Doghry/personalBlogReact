...
<div className="p-5 mt-10 mx-auto sm:p-10 md:p-16 dark:text-gray-800 container">
	<div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
		...
		<div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md dark:bg-gray-100">
...
<div className="container text-center text-white mx-auto my-10">
  <NavLink className={"Container"} to={"/collections"}>
    <buttion className="bg-flarePurple px-5 py-2 rounded-lg ">
    Back to collections
    </buttion>
    </NavLink>
</div>
